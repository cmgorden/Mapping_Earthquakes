...
d3.json("https://earthquake.usgs.gov/earthquakes/feed/v1.0/summary/all_week.geojson").then(function(data) {
  ...
  L.geoJson(data, {
    	...
    	pointToLayer: function(feature, latlng) {
      		//console.log("all earthquake data", data);
...
//5. Change the color function to use three colors for major earthquakes based on the magnitude of the earthquake.
...
// 7. Creating a GeoJSON layer with retrieved data
...
//  after the marker has been created and styled.
  L.geoJson(data, {
    onEachFeature: function(feature, layer) {
    layer.bindPopup<"<h3> Earthquake: " + feature.properties.mag + "</h3> <hr><h3> Location: " + feature.properties.location + "</h3>";
  }
...
// Create a style for the lines.
    ...
    L.geoJson(data, {
      style: myStyle,
      onEachFeature: function(feature, layer) {
        layer.bindPopup("Name: " + feature.properties.Name + "<hr> Source: " + feature.properties.Source);
      }
